...
!function () {
	...
	var touchend = function (e) {
		...
		$target = target;
		selector = '.content'
		matchesSelector = 'webkitMatchesSelector' in document.documentElement? 'webkitMatchesSelector' : 'matchesSelector';
		...
		PUSH({
			...
			container : $target || document.querySelector( '.content' ) || document.body,
