...
function fnPjax(selector, container, options) {
	...
	return this.on('touchend.pjax', selector, function(event) {
...
function pjax(options) {
	...
	options.success = function(data, status, xhr) {
		...
		console.log( '2', container, container.contents );
...
function extractContainer(data, xhr, options) {
	...
	// options.fragmet = '#pjax-container'

	console.log( 'options.fragmet', options.fragmet );
