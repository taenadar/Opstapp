...
;
(function() {
  var $map, calcRoute, directionsRenderer, directionsService, drawNewRoute, exports, findPointsOnRoute, locationsArray, map, marker, polyLine, routeBoxer, start, styledMap;
  ...
  drawNewRoute = function(waypts, origin, destination) {
    ...
    return directionsService.route(request, function(response, status) {
      ...
      return console.log(directionsRenderer);
    });
  };
